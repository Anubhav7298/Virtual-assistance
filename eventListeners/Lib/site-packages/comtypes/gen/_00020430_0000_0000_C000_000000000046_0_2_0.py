...
__all__ = [ 'OLE_XSIZE_CONTAINER', 'FONTITALIC', 'FONTSTRIKETHROUGH',
           'Gray', 'FontEvents', 'VgaColor', 'OLE_TRISTATE',
           'OLE_YPOS_HIMETRIC', 'OLE_CANCELBOOL', 'FONTNAME',
           'Monochrome', 'Unchecked', 'IFontEventsDisp', 'FONTBOLD',
           'Checked', 'OLE_XSIZE_HIMETRIC', 'OLE_XPOS_PIXELS',
           'Color', 'OLE_YSIZE_HIMETRIC', 'OLE_XSIZE_PIXELS',
           'OLE_YPOS_PIXELS', 'StdFont', 'Font', 'IPicture',
           'OLE_YSIZE_PIXELS', 'Default', 'OLE_YSIZE_CONTAINER',
           'OLE_COLOR', 'OLE_XPOS_HIMETRIC', 'IPictureDisp',
           'OLE_OPTEXCLUSIVE', 'LoadPictureConstants', 'OLE_HANDLE',
           'OLE_ENABLEDEFAULTBOOL', 'Picture', 'StdPicture',
           'OLE_XPOS_CONTAINER', 'IFont', 'IFontDisp',
